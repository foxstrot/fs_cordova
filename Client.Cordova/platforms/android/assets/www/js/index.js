...
function onDeviceReady() {
	...
	// document.querySelector("#radioPlay").addEventListener("click", play, false);
...
function playMP3() {
	console.log('ownradio ' + 'playMP3()');
    var mp3URL = getMediaURL("sounds/5315ab2f-8553-44d3-8d48-cbc4ae771260.mp3", null, null, playbackStatus);
    var media = new Media(mp3URL, null, mediaError);
    // var media = new Media("http://api.ownradio.ru/v3/tracks/0a58E548-4C24-4831-b55e-252af5301181", null, mediaError);
	console.log('ownradio ' + typeof(media));
    media.play();
}
